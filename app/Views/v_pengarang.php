          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-warning btn-flat btn-sm" data-toggle="modal" data-target="#modal-edit<?= $value['id_pengarang'] ?>">
                  <i class="fas fa-edit"></i>
                  </button>
                  <button type="button" class="btn btn-danger btn-flat btn-sm" data-toggle="modal" data-target="#modal-delete<?= $value['id_pengarang'] ?>">
  ...
  <div class="modal fade" id="modal-sm">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-body">
       <?php echo form_open(base_url('pengarang/Add')) ?>
   ...
   <div class="modal fade" id="modal-edit<?= $value['id_pengarang'] ?>">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-body">
       ...
       <div class="form-group">
         <label >Nama pengarang</label>
          <input  class="form-control" value="<?= $value['nama_pengarang'] ?>" name="nama_pengarang" placeholder="Nama pengarang" required>
      </div>
      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
   ...
   <div class="modal fade" id="modal-delete<?= $value['id_pengarang'] ?>">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-body">
       ...
       <div class="form-group">
         Apakah anda yakin hapus Data <br><b><?= $value['nama_pengarang'] ?>?</b>
